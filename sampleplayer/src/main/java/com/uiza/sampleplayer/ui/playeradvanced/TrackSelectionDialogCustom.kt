 ...
 */
class TrackSelectionDialogCustom : DialogFragment() {
        ...
        for (i in 0 until mappedTrackInfo.rendererCount) {
            if (showTabForRenderer(mappedTrackInfo, i)) {
                ...
                tabFragment.init(
                    mappedTrackInfo = mappedTrackInfo,
                    rendererIndex = i,
                    initialIsDisabled = initialParameters.getRendererDisabled(i),
                    initialOverride = initialParameters.getSelectionOverride(i, trackGroupArray),
    ...
    fun getOverrides(rendererIndex: Int): List<SelectionOverride> {
        val rendererView = tabFragments[rendererIndex]
        return if (rendererView == null) {
            emptyList()
        } else {
            rendererView.overrides ?: emptyList()
        }
    }
    ...
    override fun onCreateView(
        ...
        val dialogView = inflater.inflate(R.layout.track_selection_dialog_custom, container, false)
        val tabLayout: TabLayout = dialogView.findViewById(R.id.tabLayout)
        val viewPager: ViewPager = dialogView.findViewById(R.id.viewPager)
    ...
    class TrackSelectionViewFragment : Fragment(), TrackSelectionListener {
        ...
        override fun onCreateView(
            ...
            selectionView.setShowDisableOption(true)
