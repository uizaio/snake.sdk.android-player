 ...
 */
public final class TrackSelectionDialogCustom extends DialogFragment {
     ...
     *                          dismissed.
     */
    public static TrackSelectionDialogCustom createForTrackSelector(
            DefaultTrackSelector trackSelector, DialogInterface.OnDismissListener onDismissListener) {
        MappedTrackInfo mappedTrackInfo =
                Assertions.checkNotNull(trackSelector.getCurrentMappedTrackInfo());
        TrackSelectionDialogCustom trackSelectionDialog = new TrackSelectionDialogCustom();
     ...
     *                                dismissed.
     */
    public static TrackSelectionDialogCustom createForMappedTrackInfoAndParameters(
            int titleId,
            MappedTrackInfo mappedTrackInfo,
    ...
    public TrackSelectionDialogCustom() {
