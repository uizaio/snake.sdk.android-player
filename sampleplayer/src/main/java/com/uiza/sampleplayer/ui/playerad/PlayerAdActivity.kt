...
class PlayerAdActivity : AppCompatActivity() {
    ...
    private fun setupViews() {
        ...
        btAdSingleSkippableInline.setOnClickListener {
            onPlay(
                link = Constant.LINK_PLAY_VOD,
                urlIMAAd = "https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/external/single_ad_samples&ciu_szs=300x250&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&cust_params=deployment%3Ddevsite%26sample_ct%3Dskippablelinear&correlator="
            )
        }
        btAdSingleRedirectLinear.setOnClickListener {
            onPlay(
                link = Constant.LINK_PLAY_VOD_2,
                urlIMAAd = "https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/external/single_ad_samples&ciu_szs=300x250&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&cust_params=deployment%3Ddevsite%26sample_ct%3Dredirectlinear&correlator="
            )
        }
    }
